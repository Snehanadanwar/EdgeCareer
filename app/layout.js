...
export const metadata = {
  title: "AI career advisor - Your AI-Powered Career Assistant",
  description:
    ...
    <ClerkProvider appearance={{ baseTheme: dark }}>
      <html lang="en" suppressHydrationWarning className="dark">
        <head>
          ...
          />
          <meta name="author" content="AI career advisor" />
          ...
          <meta property="og:url" content="https://ai career advisor.com" />
          <meta property="og:image" content="https://ai career advisor.com/og-image.png" />

          {/* Twitter Card Meta Tags */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={metadata.title} />
          <meta name="twitter:description" content={metadata.description} />
          <meta name="twitter:image" content="https://ai career advisor.com/og-image.png" />
        </head>
